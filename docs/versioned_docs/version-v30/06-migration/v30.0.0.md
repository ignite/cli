...
v30.0.0 adds [gno.land](https://gno.land) smart contract support to Ignite CLI alongside the existing Cosmos SDK tooling. The changes that matter for existing users:
