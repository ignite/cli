...
```bash
ethappcli rest-server --laddr "tcp://localhost:8545"  --chain-id "yourchainid" --trace --unlock-key=user1
```
...
This will be our reference in solidity. We can now interact with this contract with JavaScript. 
...
[◀️ Previous - Smart Contracts](../../04_usecases/01_smart_contracts/01_smart_contracts.md) | [▶️ Next - CW20](../../04%20Use%20cases/03_cw20/03_cw20.md)  