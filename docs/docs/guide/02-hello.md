...
This tutorial is based on a specific version of Ignite CLI, so be sure to install the correct version. 
...
- After the chain has been started, visit [http://localhost:1317/hello/hello/hello](http://localhost:1317/hello/hello/hello) 
