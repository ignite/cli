...
The frontend app is built using the `@ignite/vue` and `@ignite/vuex` packages. For details, see the [monorepo for Ignite CLI front-end development](https://github.com/tendermint/vue).
