...
- A supported version of [Ignite CLI](https://docs.starport.com/). To install Ignite CLI, see [Install Ignite CLI](../starport/install.md). 
...
- [Ignite CLI](https://docs.starport.com/) is built on top of Cosmos SDK and accelerates chain development by scaffolding everything you need. 
