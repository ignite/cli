...
Because Ignite CLI does the heavy lifting for you, choose from several [starport scaffold](https://docs.starport.com/cli/#starport-scaffold) commands to create CRUD functionality code for data stored in different ways:
