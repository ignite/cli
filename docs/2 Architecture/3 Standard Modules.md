...
<!-- moved from intro, park here temporarily during edit -->
...
When creating a blockchain with Starport or manually with the Cosmos SDK, this standard set of modules provides a set of rules that define a blockchain: <!-- change links to the Cosmos SDK docs and provide very brief description -->
...
<!-- remove duplicate content, very scope -->
