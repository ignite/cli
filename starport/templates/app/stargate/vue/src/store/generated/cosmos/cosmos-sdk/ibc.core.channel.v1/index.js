    ...
    actions: {
        ...
        async QueryChannel({ commit, rootGetters }, { subscribe = false, ...key }) {
            try {
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryChannel', payload: key });
            }
            catch (e) {
        ...
        async QueryChannels({ commit, rootGetters }, { subscribe = false, ...key }) {
            try {
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryChannels', payload: key });
            }
            catch (e) {
        ...
        async QueryConnectionChannels({ commit, rootGetters }, { subscribe = false, ...key }) {
            try {
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryConnectionChannels', payload: key });
            }
            catch (e) {
        ...
        async QueryChannelClientState({ commit, rootGetters }, { subscribe = false, ...key }) {
            try {
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryChannelClientState', payload: key });
            }
            catch (e) {
        ...
        async QueryChannelConsensusState({ commit, rootGetters }, { subscribe = false, ...key }) {
            try {
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryChannelConsensusState', payload: key });
            }
            catch (e) {
        ...
        async QueryPacketCommitment({ commit, rootGetters }, { subscribe = false, ...key }) {
            try {
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryPacketCommitment', payload: key });
            }
            catch (e) {
        ...
        async QueryPacketCommitments({ commit, rootGetters }, { subscribe = false, ...key }) {
            try {
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryPacketCommitments', payload: key });
            }
            catch (e) {
        ...
        async QueryPacketReceipt({ commit, rootGetters }, { subscribe = false, ...key }) {
            try {
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryPacketReceipt', payload: key });
            }
            catch (e) {
        ...
        async QueryPacketAcknowledgement({ commit, rootGetters }, { subscribe = false, ...key }) {
            try {
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryPacketAcknowledgement', payload: key });
            }
            catch (e) {
        ...
        async QueryPacketAcknowledgements({ commit, rootGetters }, { subscribe = false, ...key }) {
            try {
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryPacketAcknowledgements', payload: key });
            }
            catch (e) {
        ...
        async QueryUnreceivedPackets({ commit, rootGetters }, { subscribe = false, ...key }) {
            try {
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryUnreceivedPackets', payload: key });
            }
            catch (e) {
        ...
        async QueryUnreceivedAcks({ commit, rootGetters }, { subscribe = false, ...key }) {
            try {
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryUnreceivedAcks', payload: key });
            }
            catch (e) {
        ...
        async QueryNextSequenceReceive({ commit, rootGetters }, { subscribe = false, ...key }) {
            try {
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryNextSequenceReceive', payload: key });
            }
            catch (e) {
