...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/cosmos/cosmos-sdk v0.46.0-beta2.0.20240806191935-adcf958f34e9
)
...
require (
	...
	cosmossdk.io/x/tx v0.13.4-0.20240802064046-23fac2f1b8ab // indirect
