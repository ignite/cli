...
replace (
	cosmossdk.io/api => cosmossdk.io/api v0.7.3-0.20240911201245-4fe934e8af85 // main
	cosmossdk.io/core => cosmossdk.io/core v1.0.0-alpha.1 // main
	cosmossdk.io/store => cosmossdk.io/store v1.0.0-rc.0.0.20240911201245-4fe934e8af85 // main
	cosmossdk.io/x/accounts => cosmossdk.io/x/accounts v0.0.0-20240911202929-e7724c664784 // release/v0.52.x
	cosmossdk.io/x/bank => cosmossdk.io/x/bank v0.0.0-20240911202929-e7724c664784 // release/v0.52.x
	cosmossdk.io/x/consensus => cosmossdk.io/x/consensus v0.0.0-20240911202929-e7724c664784 // release/v0.52.x
	cosmossdk.io/x/staking => cosmossdk.io/x/staking v0.0.0-20240911202929-e7724c664784 // release/v0.52.x
