...
func (_m *PluginInterface) Execute(_a0 context.Context, _a1 *v1.ExecutedCommand) error {
	ret := _m.Called(_a0, _a1)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *v1.ExecutedCommand) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *PluginInterface_Expecter) Execute(_a0 interface{}, _a1 interface{}) *PluginInterface_Execute_Call {
	return &PluginInterface_Execute_Call{Call: _e.mock.On("Execute", _a0, _a1)}
}

func (_c *PluginInterface_Execute_Call) Run(run func(_a0 context.Context, _a1 *v1.ExecutedCommand)) *PluginInterface_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*v1.ExecutedCommand))
	})
	return _c
}
...
// ExecuteHookCleanUp provides a mock function with given fields: _a0, _a1
func (_m *PluginInterface) ExecuteHookCleanUp(_a0 context.Context, _a1 *v1.ExecutedHook) error {
	ret := _m.Called(_a0, _a1)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *v1.ExecutedHook) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
...
//   - _a0 context.Context
//   - _a1 *v1.ExecutedHook
func (_e *PluginInterface_Expecter) ExecuteHookCleanUp(_a0 interface{}, _a1 interface{}) *PluginInterface_ExecuteHookCleanUp_Call {
	return &PluginInterface_ExecuteHookCleanUp_Call{Call: _e.mock.On("ExecuteHookCleanUp", _a0, _a1)}
}

func (_c *PluginInterface_ExecuteHookCleanUp_Call) Run(run func(_a0 context.Context, _a1 *v1.ExecutedHook)) *PluginInterface_ExecuteHookCleanUp_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*v1.ExecutedHook))
	})
	return _c
}
...
// ExecuteHookPost provides a mock function with given fields: _a0, _a1
func (_m *PluginInterface) ExecuteHookPost(_a0 context.Context, _a1 *v1.ExecutedHook) error {
	ret := _m.Called(_a0, _a1)
...
//   - _a0 context.Context
//   - _a1 *v1.ExecutedHook
func (_e *PluginInterface_Expecter) ExecuteHookPost(_a0 interface{}, _a1 interface{}) *PluginInterface_ExecuteHookPost_Call {
	return &PluginInterface_ExecuteHookPost_Call{Call: _e.mock.On("ExecuteHookPost", _a0, _a1)}
}

func (_c *PluginInterface_ExecuteHookPost_Call) Run(run func(_a0 context.Context, _a1 *v1.ExecutedHook)) *PluginInterface_ExecuteHookPost_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*v1.ExecutedHook))
	})
	return _c
...
// ExecuteHookPre provides a mock function with given fields: _a0, _a1
func (_m *PluginInterface) ExecuteHookPre(_a0 context.Context, _a1 *v1.ExecutedHook) error {
	ret := _m.Called(_a0, _a1)
...
//   - _a0 context.Context
//   - _a1 *v1.ExecutedHook
func (_e *PluginInterface_Expecter) ExecuteHookPre(_a0 interface{}, _a1 interface{}) *PluginInterface_ExecuteHookPre_Call {
	return &PluginInterface_ExecuteHookPre_Call{Call: _e.mock.On("ExecuteHookPre", _a0, _a1)}
}

func (_c *PluginInterface_ExecuteHookPre_Call) Run(run func(_a0 context.Context, _a1 *v1.ExecutedHook)) *PluginInterface_ExecuteHookPre_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*v1.ExecutedHook))
	})
	return _c
