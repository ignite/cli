...
import (
	...
	chainconfigv1 "github.com/ignite/cli/v30/ignite/config/chain/v1"
	...
	"github.com/ignite/cli/v30/ignite/pkg/repoversion"
	"github.com/ignite/cli/v30/ignite/pkg/xexec"
	"github.com/ignite/cli/v30/ignite/pkg/xurl"
	igniteversion "github.com/ignite/cli/v30/ignite/version"
)
...
func (c *Chain) RPCPublicAddress() (string, error) {
	...
	return servers.RPC.Address, nil
}
