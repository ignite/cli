...
// NewQueryClient creates a new instance of BankClient. It also registers a cleanup function to assert the mocks expectations.
func NewQueryClient(t testing.TB) *BankClient {
	mock := &BankClient{}
