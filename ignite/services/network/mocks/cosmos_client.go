...
// IBCInfo provides a mock function with given fields: height
func (_m *CosmosClient) IBCInfo(height int64) (*cosmosclient.IBC, error) {
	ret := _m.Called(height)

	var r0 *cosmosclient.IBC
	if rf, ok := ret.Get(0).(func(int64) *cosmosclient.IBC); ok {
		r0 = rf(height)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*cosmosclient.IBC)
		}
	}
