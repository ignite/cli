...
`,
	...
	// c.AddCommand(NewGenerateTSClient()) // disabled until ts-client works better, in the meantine, ignite app web is the way to go
	// c.AddCommand(NewGenerateComposables()) // disabled until ts-client works better, in the meantine, ignite app web is the way to go
	// c.AddCommand(NewGenerateHooks()) // disabled until ts-client works better, in the meantine, ignite app web is the way to go
