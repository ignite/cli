...
func ReadConfigVersion(configFile io.Reader) (baseconfig.Version, error) {
	c := struct {
		Version baseconfig.Version `yaml:"version"`
	}{}
...
func decodeConfig(r io.Reader, version baseconfig.Version) (baseconfig.Converter, error) {
