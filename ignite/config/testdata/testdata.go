...
import (
	...
	networkconfigTestdata "github.com/ignite/cli/v30/ignite/config/chain/network/testdata"
	v0testdata "github.com/ignite/cli/v30/ignite/config/chain/v0/testdata"
	v1testdata "github.com/ignite/cli/v30/ignite/config/chain/v1/testdata"
