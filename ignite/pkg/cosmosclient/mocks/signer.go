...
func (_m *Signer) Sign(ctx client.Context, txf tx.Factory, name string, txBuilder client.TxBuilder, overwriteSig bool) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(client.Context, tx.Factory, string, client.TxBuilder, bool) error); ok {
...
func (_c *Signer_Sign_Call) Run(run func(ctx client.Context, txf tx.Factory, name string, txBuilder client.TxBuilder, overwriteSig bool)) *Signer_Sign_Call {
...
func (_c *Signer_Sign_Call) RunAndReturn(run func(client.Context, tx.Factory, string, client.TxBuilder, bool) error) *Signer_Sign_Call {
	_c.Call.Return(run)
	return _c
}
