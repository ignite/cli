...
// NewSaver creates a new instance of Saver. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewSaver(t testing.TB) *Saver {
	mock := &Saver{}
	mock.Mock.Test(t)
