...
func TestTCP(t *testing.T) {
	cases := []struct {
		...
		{
			name: "with scheme",
			addr: "tcp://github.com/ignite/cli/v30",
			want: "tcp://github.com/ignite/cli/v30",
		},
		{
			name: "without scheme",
			addr: "github.com/ignite/cli/v30",
			want: "tcp://github.com/ignite/cli/v30",
		},
		{
			name: "with invalid scheme",
			addr: "ftp://github.com/ignite/cli/v30",
			want: "tcp://github.com/ignite/cli/v30",
		},
		{
...
func TestHTTP(t *testing.T) {
	cases := []struct {
		...
		{
			name: "with scheme",
			addr: "http://github.com/ignite/cli/v30",
			want: "http://github.com/ignite/cli/v30",
		},
		{
			name: "without scheme",
			addr: "github.com/ignite/cli/v30",
...
func TestHTTPS(t *testing.T) {
	cases := []struct {
		...
		{
			name: "with scheme",
			addr: "https://github.com/ignite/cli/v30",
			want: "https://github.com/ignite/cli/v30",
		},
		{
			name: "without scheme",
			addr: "github.com/ignite/cli/v30",
...
func TestWS(t *testing.T) {
	cases := []struct {
		...
		{
			name: "with scheme",
			addr: "ws://github.com/ignite/cli/v30",
			want: "ws://github.com/ignite/cli/v30",
		},
		{
			name: "without scheme",
			addr: "github.com/ignite/cli/v30",
