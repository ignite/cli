...
- [#4691](https://github.com/ignite/cli/pull/4691), [](https://github.com/ignite/cli/pull/) Fix ts-client query template and solely Go template for `ts-client` generation.
